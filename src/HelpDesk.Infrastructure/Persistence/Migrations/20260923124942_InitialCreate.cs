    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Laptops, desktops and printers", true, "Hardware" },
                    { 2, "Applications and licenses", true, "Software" },
                    { 3, "Connectivity and VPN", true, "Network" },
                    { 4, "Passwords and permissions", true, "Access & Accounts" },
                    { 5, "Anything that does not fit elsewhere", true, "Other" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Finance and Accounting", "Finance" },
                    { 4, "Business Operations", "Operations" }
                });
